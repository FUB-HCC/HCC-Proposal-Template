...
{\normalsize --<BSc/MSc> Thesis Proposal--\\
...
% TODO Please use the email adress provided by FU Berlin.
...
{\normalsize Date of Submission: <Month, DD, YYYY>}\\
...
\normalsize<First name Last name>\footnote{Dept. of Computer Science and Mathematics, Human-Centered Computing (HCC) Research Group}, Freie Universität Berlin, Germany}\\\\

{\normalsize Reviewers:\\
\normalsize Prof. Dr. Claudia Müller-Birn\footnote{Dept. of Computer Science and Mathematics, Human-Centered Computing (HCC) Research Group}, Freie Universität Berlin, Germany\\
% TODO: Add the name of your second reviewer.
\normalsize <Prof. Dr. Second Reviewer\footnote{Dept. of Computer Science and Mathematics, <Name of Research Group>}>, Freie Universität Berlin, Germany}\\\\
}
